...
const MyVotes = () => {
    ...
    if (errorMessage) {
        return <div className='min-h-screen flex items-center justify-center'><ErrorMessage heading="Error fetching the my votes" message={errorMessage} action={resetPolls} /></div>
    }
